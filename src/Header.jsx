			...
			<header className=" flex justify-between items-center">
				<Link to={user ? '/' : '/login'} className="flex  ">
					<svg
						...
						strokeWidth="1.5"
						stroke="currentColor"
						className="w-8 h-8 -rotate-90 text-red-400"
					>
						<path
							strokeLinecap="round"
					...
					<span className="text-xl font-bold text-red-400">aircnc </span>
				</Link>

				<div className="flex gap-2 border border-gray-400 rounded-full py-2 px-4 shadow-md shadow-gray-300">
					<div>Anywhere</div>
					<div className="border border-l-2 border-gray-300"></div>
					<div>Any Week</div>
					<div className="border border-l-2 border-gray-300"></div>
					<div>Add Guest</div>
					<div className="border border-l-2 border-gray-300"></div>
				...
				<Link
					to={Object.keys(user).length > 0 ? '/account' : '/login'}
